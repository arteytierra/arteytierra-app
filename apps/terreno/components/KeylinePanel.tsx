...
import { Check, Waypoints, Loader2, MapPin, Info, Grid3x3 } from 'lucide-react';
...
// ─── Factores de la Escala de Permanencia (Yeomans) ────────────────────────────
const FACTORES: Array<{ id: string; nombre: string; desc: string }> = [
...
export function KeylinePanel({ mojones, datosShader, parcelas, check, onCheck, onAplicarGuias, onAplicarPatron }: Props) {
