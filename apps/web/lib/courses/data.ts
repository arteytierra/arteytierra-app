...
export const COURSES: Record<string, CourseData> = {
  ...
  'bioarquitectura': {
    ...
    galeria: ['/img/cursos/bioarquitectura/2.jpg', '/img/cursos/bioarquitectura/3.jpg', '/img/cursos/bioarquitectura/4.jpg'],
    ...
    datos: [
      { label: '¿Cuándo?', val: '18 y 19 de julio 2026 · Sábado y domingo' },
    ...
    formCurso: 'Bioarquitectura, Construcción y Territorio · 18 y 19 julio 2026',
  ...
  'vuelta-a-la-tierra': {
    ...
    tag: 'Inicia lunes 12 de octubre 2026 · Online en vivo',
    intro: [
    ...
    modulos: [
      { num: 'Intro', title: 'Visión Integral del Hábitat', date: 'Lunes 12 oct', items: ['Presentación del programa', 'Metodología de trabajo', 'Lectura del proceso de transición al campo'] },
      ...
      { num: 'Cierre', title: 'Integración y Devolución Colectiva', date: 'Jueves 26 noviembre', items: ['Revisión general', 'Orientación final', 'Preparación de entrega integradora', 'Devolución colectiva'] },
  ...
  'cultivo-girgolas': {
    ...
    tag: 'Tres sábados · 11/7 · 1/8 · 22/8 · 2026 · Tay Pichín',
    intro: [
    ...
    datos: [
      { label: 'Fechas', val: '11 jul · 1 ago · 22 ago 2026 (sábados)' },
  ...
  'inmersion-viva': {
    ...
    datos: [
      { label: 'Duración', val: '15 días o 30 días (según disponibilidad)' },
      { label: '¿Dónde?', val: 'Ecoescuela Tay Pichín · San Marcos Sierras, Córdoba' },
    ...
    facilitadores: [JONATAN],
    opciones: [
      { id: '15-dias', label: 'Inmersión de 15 días', precio: 'Consultanos', includes: ['Alojamiento en Tay Pichín', 'Alimentación completa', 'Participación en todas las actividades', 'Certificado de participación'] },
      { id: '30-dias', label: 'Inmersión de 30 días', precio: 'Consultanos', includes: ['Alojamiento en Tay Pichín', 'Alimentación completa', 'Participación en todas las actividades', 'Proyecto integrador personal', 'Certificado de participación'], highlighted: true },
    ],
    opcionesNota: 'Consultanos disponibilidad y fechas por WhatsApp. Las inmersiones se coordinan según la actividad de la ecoescuela.',
