...
export const COURSES: Record<string, CourseData> = {
  ...
  'formacion-integral-intensivo': {
    ...
    datos: [
      ...
      { label: 'Grupo', val: 'Acompañamiento cercano y personalizado' },
    ],
    paraQuien: [
    ...
    modulos: [
      ...
      { num: 'Día 3', title: 'Revoque fino y pinturas', items: ['Revoque fino de barro y de cal', 'Texturas y acabados', 'Pinturas naturales de tierra', 'Pinturas de cal y pigmentos'] },
      {
        ...
        nota: 'No es solo más técnica: es vida de obra. Se suman oficios afines y encuentros que abren la mirada más allá del muro.',
        items: [
          'Techo verde',
          'Estructuras en madera',
          'Colocación de aberturas',
          'Charla de radiestesia y geobiología',
          'Introducción a la arquitectura simbiótica',
          'Más práctica de muros y revoques',
        ],
        wide: true,
      },
    ],
